...
public class DiscordServiceImpl implements DiscordService {
    ...
    private String settingsParamsJson;
    private String resetSettingsParamsJson;
    private String preferRemixParamsJson;
    ...
    void init() {
        ...
        this.settingsParamsJson = ResourceUtil.readUtf8Str("api-params/settings.json");
        this.resetSettingsParamsJson = ResourceUtil.readUtf8Str("api-params/reset-settings.json");
        this.preferRemixParamsJson = ResourceUtil.readUtf8Str("api-params/prefer-remix.json");
    ...
    @Override
    public Message<Void> settings() {
        String paramsStr = this.settingsParamsJson.replace("$guild_id", this.discordGuildId)
                .replace("$channel_id", this.discordChannelId)
                .replace("$session_id", this.discordSessionId);
        JSONObject params = new JSONObject(paramsStr);
        return postJsonAndCheckStatus(params.toString());
    ...
    @Override
    public Message<Void> resetSettings(String messageId) {
        String paramsStr = this.resetSettingsParamsJson.replace("$guild_id", this.discordGuildId)
                .replace("$channel_id", this.discordChannelId)
                .replace("$session_id", this.discordSessionId)
                .replace("$message_id", messageId);
        JSONObject params = new JSONObject(paramsStr);
    ...
    @Override
    public Message<Void> preferRemix() {
        String paramsStr = this.preferRemixParamsJson.replace("$guild_id", this.discordGuildId)
                .replace("$channel_id", this.discordChannelId)
                .replace("$session_id", this.discordSessionId);
        JSONObject params = new JSONObject(paramsStr);
        return postJsonAndCheckStatus(params.toString());
